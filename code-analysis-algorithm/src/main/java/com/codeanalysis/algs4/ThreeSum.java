...
import com.codeanalysis.algs4.Stopwatch;
...
public class ThreeSum {
    ...
    public static void printAll(int[] a) {
        ...
        for (int i = 0; i < n; i++) {
            for (int j = i+1; j < n; j++) {
                for (int k = j+1; k < n; k++) {
                    if (a[i] + a[j] + a[k] == 0) {
                        com.codeanalysis.algs4.StdOut.println(a[i] + " " + a[j] + " " + a[k]);
                    }
                }
            }
        }
    ...
    public static void main(String[] args)  { 
        ...
        int count = count(a);
        com.codeanalysis.algs4.StdOut.println("elapsed time = " + timer.elapsedTime());
