...
import com.codeanalysis.algs4.BreadthFirstDirectedPaths;
import com.codeanalysis.algs4.DepthFirstDirectedPaths;
...
public class DirectedDFS {
     ...
     */
    public DirectedDFS(com.codeanalysis.algs4.Digraph G, int s) {
     ...
     */
    public DirectedDFS(com.codeanalysis.algs4.Digraph G, Iterable<Integer> sources) {
        marked = new boolean[G.V()];
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.Bag<Integer> sources = new Bag<Integer>();
        ...
        for (int v = 0; v < G.V(); v++) {
            if (dfs.marked(v)) com.codeanalysis.algs4.StdOut.print(v + " ");
        }
        StdOut.println();
    }
