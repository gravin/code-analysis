...
import com.codeanalysis.algs4.FlowEdge;
import com.codeanalysis.algs4.FlowNetwork;
...
public class FordFulkerson {
    ...
    private com.codeanalysis.algs4.FlowEdge[] edgeTo;    // edgeTo[v] = last edge on shortest residual s->v path
     ...
     */
    public FordFulkerson(com.codeanalysis.algs4.FlowNetwork G, int s, int t) {
        V = G.V();
        validate(s);
        validate(t);
    ...
    private boolean hasAugmentingPath(com.codeanalysis.algs4.FlowNetwork G, int s, int t) {
        edgeTo = new com.codeanalysis.algs4.FlowEdge[G.V()];
        marked = new boolean[G.V()];

        // breadth-first search
        com.codeanalysis.algs4.Queue<Integer> queue = new Queue<Integer>();
        queue.enqueue(s);
        marked[s] = true;
        while (!queue.isEmpty() && !marked[t]) {
            int v = queue.dequeue();

            for (com.codeanalysis.algs4.FlowEdge e : G.adj(v)) {
                int w = e.other(v);
    ...
    private double excess(com.codeanalysis.algs4.FlowNetwork G, int v) {
        double excess = 0.0;
        for (com.codeanalysis.algs4.FlowEdge e : G.adj(v)) {
    ...
    // return excess flow at vertex v
    private boolean isFeasible(com.codeanalysis.algs4.FlowNetwork G, int s, int t) {
    ...
    // check optimality conditions
    private boolean check(com.codeanalysis.algs4.FlowNetwork G, int s, int t) {
    ...
    public static void main(String[] args) {
        ...
        int s = 0, t = V-1;
        com.codeanalysis.algs4.FlowNetwork G = new FlowNetwork(V, E);
        com.codeanalysis.algs4.StdOut.println(G);

        // compute maximum flow and minimum cut
        FordFulkerson maxflow = new FordFulkerson(G, s, t);
        com.codeanalysis.algs4.StdOut.println("Max flow from " + s + " to " + t);
        for (int v = 0; v < G.V(); v++) {
        ...
        // print min-cut
        com.codeanalysis.algs4.StdOut.print("Min cut: ");
        for (int v = 0; v < G.V(); v++) {
            if (maxflow.inCut(v)) com.codeanalysis.algs4.StdOut.print(v + " ");
        }
