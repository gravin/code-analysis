...
public class BellmanFordSP {
    ...
    private com.codeanalysis.algs4.DirectedEdge[] edgeTo;         // edgeTo[v] = last edge on shortest s->v path
    private boolean[] onQueue;             // onQueue[v] = is v currently on the queue?
    private com.codeanalysis.algs4.Queue<Integer> queue;          // queue of vertices to relax
    private int cost;                      // number of calls to relax()
    private Iterable<com.codeanalysis.algs4.DirectedEdge> cycle;  // negative cycle (or null if no such cycle)
    ...
    public BellmanFordSP(EdgeWeightedDigraph G, int s) {
        ...
        edgeTo  = new com.codeanalysis.algs4.DirectedEdge[G.V()];
     ...
     * @throws IllegalArgumentException unless {@code 0 <= v < V}
     */
    public Iterable<com.codeanalysis.algs4.DirectedEdge> pathTo(int v) {
        validateVertex(v);
        if (hasNegativeCycle())
            throw new UnsupportedOperationException("Negative cost cycle exists");
        if (!hasPathTo(v)) return null;
        com.codeanalysis.algs4.Stack<com.codeanalysis.algs4.DirectedEdge> path = new Stack<com.codeanalysis.algs4.DirectedEdge>();
        for (com.codeanalysis.algs4.DirectedEdge e = edgeTo[v]; e != null; e = edgeTo[e.from()]) {
            path.push(e);
        }
        return path;
    }
    ...
    private boolean check(EdgeWeightedDigraph G, int s) {
        ...
        if (hasNegativeCycle()) {
            double weight = 0.0;
            for (com.codeanalysis.algs4.DirectedEdge e : negativeCycle()) {
                weight += e.weight();
            }
            if (weight >= 0.0) {
        ...
        // no negative cycle reachable from source
            ...
            for (int w = 0; w < G.V(); w++) {
                ...
                com.codeanalysis.algs4.DirectedEdge e = edgeTo[w];
                int v = e.from();
        ...
        com.codeanalysis.algs4.StdOut.println("Satisfies optimality conditions");
    ...
    public static void main(String[] args) {
        ...
        if (sp.hasNegativeCycle()) {
            for (com.codeanalysis.algs4.DirectedEdge e : sp.negativeCycle())
        ...
        // print shortest paths
            ...
            for (int v = 0; v < G.V(); v++) {
                if (sp.hasPathTo(v)) {
                    com.codeanalysis.algs4.StdOut.printf("%d to %d (%5.2f)  ", s, v, sp.distTo(v));
