...
/**
 *  The {@code LongestCommonSubstring} class provides a {@link com.codeanalysis.algs4.SuffixArray}
...
public class LongestCommonSubstring {
    ...
    public static String lcs(String s, String t) {
        com.codeanalysis.algs4.SuffixArray suffix1 = new com.codeanalysis.algs4.SuffixArray(s);
        com.codeanalysis.algs4.SuffixArray suffix2 = new SuffixArray(t);
    ...
    public static void main(String[] args) {
        com.codeanalysis.algs4.In in1 = new com.codeanalysis.algs4.In(args[0]);
        com.codeanalysis.algs4.In in2 = new In(args[1]);
