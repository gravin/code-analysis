    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if ((!line[0].equals("set") && !line[0].equals("init")) && ft == null) {
                com.codeanalysis.algs4.StdOut.println("FenwickTree not initialized");
                continue;
            }
            ...
            if (line[0].equals("init")) {
                ...
                for (int i = 1; i <= ft.size(); i++) {
                    com.codeanalysis.algs4.StdOut.print(ft.rsq(i, i) + " ");
                }
                ...
                com.codeanalysis.algs4.StdOut.printf("Sum from %d to %d = %d%n", arg1, arg2, ft.rsq(arg1, arg2));
            }
            else {
