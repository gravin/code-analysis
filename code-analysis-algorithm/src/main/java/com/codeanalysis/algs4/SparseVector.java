...
import com.codeanalysis.algs4.Vector;
...
public class SparseVector {
    ...
    private com.codeanalysis.algs4.ST<Integer, Double> st;  // the vector, represented by index-value pairs
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.StdOut.println("a dot b = " + a.dot(b));
