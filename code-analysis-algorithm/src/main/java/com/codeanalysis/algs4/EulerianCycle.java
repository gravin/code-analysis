...
import com.codeanalysis.algs4.Queue;
...
public class EulerianCycle {
    private com.codeanalysis.algs4.Stack<Integer> cycle = new com.codeanalysis.algs4.Stack<Integer>();  // Eulerian cycle; null if no such cycle
     ...
     * @param G the graph
     */
    public EulerianCycle(com.codeanalysis.algs4.Graph G) {
        ...
        com.codeanalysis.algs4.Queue<Edge>[] adj = (com.codeanalysis.algs4.Queue<Edge>[]) new com.codeanalysis.algs4.Queue[G.V()];
        for (int v = 0; v < G.V(); v++)
    ...
    private static int nonIsolatedVertex(com.codeanalysis.algs4.Graph G) {
        for (int v = 0; v < G.V(); v++)
            if (G.degree(v) > 0)
                return v;
        return -1;
    ...
    private static boolean satisfiesNecessaryAndSufficientConditions(com.codeanalysis.algs4.Graph G) {
        ...
        int s = nonIsolatedVertex(G);
        com.codeanalysis.algs4.BreadthFirstPaths bfs = new BreadthFirstPaths(G, s);
        for (int v = 0; v < G.V(); v++)
    ...
    private boolean certifySolution(com.codeanalysis.algs4.Graph G) {
    ...
    private static void unitTest(com.codeanalysis.algs4.Graph G, String description) {
    ...
    public static void main(String[] args) {
        ...
        // Eulerian cycle
        com.codeanalysis.algs4.Graph G1 = GraphGenerator.eulerianCycle(V, E);
        unitTest(G1, "Eulerian cycle");

        // Eulerian path
        com.codeanalysis.algs4.Graph G2 = GraphGenerator.eulerianPath(V, E);
        unitTest(G2, "Eulerian path");

        // empty graph
        com.codeanalysis.algs4.Graph G3 = new com.codeanalysis.algs4.Graph(V);
        unitTest(G3, "empty graph");

        // self loop
        com.codeanalysis.algs4.Graph G4 = new com.codeanalysis.algs4.Graph(V);
        int v4 = com.codeanalysis.algs4.StdRandom.uniform(V);
        G4.addEdge(v4, v4);
        unitTest(G4, "single self loop");

        // union of two disjoint cycles
        com.codeanalysis.algs4.Graph H1 = GraphGenerator.eulerianCycle(V/2, E/2);
        com.codeanalysis.algs4.Graph H2 = GraphGenerator.eulerianCycle(V - V/2, E - E/2);
        int[] perm = new int[V];
        for (int i = 0; i < V; i++)
            perm[i] = i;
        StdRandom.shuffle(perm);
        com.codeanalysis.algs4.Graph G5 = new com.codeanalysis.algs4.Graph(V);
