...
import com.codeanalysis.algs4.AdjMatrixEdgeWeightedDigraph;
import com.codeanalysis.algs4.DirectedEdge;
import com.codeanalysis.algs4.EdgeWeightedDigraph;
import com.codeanalysis.algs4.EdgeWeightedDirectedCycle;
...
public class FloydWarshall {
    ...
    private com.codeanalysis.algs4.DirectedEdge[][] edgeTo;   // edgeTo[v][w] = last edge on shortest v->w path
    ...
    public FloydWarshall(AdjMatrixEdgeWeightedDigraph G) {
        ...
        edgeTo = new com.codeanalysis.algs4.DirectedEdge[V][V];
        ...
        for (int v = 0; v < G.V(); v++) {
            for (com.codeanalysis.algs4.DirectedEdge e : G.adj(v)) {
     ...
     */
    public Iterable<com.codeanalysis.algs4.DirectedEdge> negativeCycle() {
     ...
     * @throws IllegalArgumentException unless {@code 0 <= v < V}
     */
    public Iterable<com.codeanalysis.algs4.DirectedEdge> path(int s, int t) {
        validateVertex(s);
        validateVertex(t);
        if (hasNegativeCycle())
            throw new UnsupportedOperationException("Negative cost cycle exists");
        if (!hasPath(s, t)) return null;
        com.codeanalysis.algs4.Stack<com.codeanalysis.algs4.DirectedEdge> path = new Stack<com.codeanalysis.algs4.DirectedEdge>();
        for (com.codeanalysis.algs4.DirectedEdge e = edgeTo[s][t]; e != null; e = edgeTo[s][e.from()]) {
            path.push(e);
        }
        return path;
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < E; i++) {
            ...
            if (v == w) G.addEdge(new com.codeanalysis.algs4.DirectedEdge(v, w, Math.abs(weight)));
            else G.addEdge(new com.codeanalysis.algs4.DirectedEdge(v, w, weight));
        }

        com.codeanalysis.algs4.StdOut.println(G);

        // run Floyd-Warshall algorithm
        FloydWarshall spt = new FloydWarshall(G);

        // print all-pairs shortest path distances
        com.codeanalysis.algs4.StdOut.printf("  ");
        for (int v = 0; v < G.V(); v++) {
            com.codeanalysis.algs4.StdOut.printf("%6d ", v);
        }
        com.codeanalysis.algs4.StdOut.println();
        for (int v = 0; v < G.V(); v++) {
            com.codeanalysis.algs4.StdOut.printf("%3d: ", v);
            for (int w = 0; w < G.V(); w++) {
                if (spt.hasPath(v, w)) com.codeanalysis.algs4.StdOut.printf("%6.2f ", spt.dist(v, w));
                else com.codeanalysis.algs4.StdOut.printf("  Inf ");
            }
            com.codeanalysis.algs4.StdOut.println();
        }
        ...
        if (spt.hasNegativeCycle()) {
            com.codeanalysis.algs4.StdOut.println("Negative cost cycle:");
            for (com.codeanalysis.algs4.DirectedEdge e : spt.negativeCycle())
                com.codeanalysis.algs4.StdOut.println(e);
            com.codeanalysis.algs4.StdOut.println();
        }
        ...
        // print all-pairs shortest paths
            ...
            for (int v = 0; v < G.V(); v++) {
                for (int w = 0; w < G.V(); w++) {
                    if (spt.hasPath(v, w)) {
                        com.codeanalysis.algs4.StdOut.printf("%d to %d (%5.2f)  ", v, w, spt.dist(v, w));
                        for (DirectedEdge e : spt.path(v, w))
                            com.codeanalysis.algs4.StdOut.print(e + "  ");
                        com.codeanalysis.algs4.StdOut.println();
                    }
                    else {
