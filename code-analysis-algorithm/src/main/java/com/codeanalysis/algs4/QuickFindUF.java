...
public class QuickFindUF {
    ...
    public static void main(String[] args) {
        ...
        while (!com.codeanalysis.algs4.StdIn.isEmpty()) {
            int p = com.codeanalysis.algs4.StdIn.readInt();
            int q = StdIn.readInt();
            if (uf.find(p) == uf.find(q)) continue;
            uf.union(p, q);
            com.codeanalysis.algs4.StdOut.println(p + " " + q);
        }
