...
import com.codeanalysis.algs4.StdArrayIO;
...
public final class StdStats {
   ...
   /**
    ...
    public static void plotPoints(double[] a) {
        validateNotNull(a);
        int n = a.length;
        com.codeanalysis.algs4.StdDraw.setXscale(-1, n);
        com.codeanalysis.algs4.StdDraw.setPenRadius(1.0 / (3.0 * n));
        for (int i = 0; i < n; i++) {
            com.codeanalysis.algs4.StdDraw.point(i, a[i]);
        }
    }
   ...
   /**
    ...
    public static void plotLines(double[] a) {
        ...
        int n = a.length;
        com.codeanalysis.algs4.StdDraw.setXscale(-1, n);
        com.codeanalysis.algs4.StdDraw.setPenRadius();
        for (int i = 1; i < n; i++) {
            com.codeanalysis.algs4.StdDraw.line(i-1, a[i-1], i, a[i]);
        }
    }
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.StdOut.printf("       min %10.3f\n", min(a));
        com.codeanalysis.algs4.StdOut.printf("      mean %10.3f\n", mean(a));
        com.codeanalysis.algs4.StdOut.printf("       max %10.3f\n", max(a));
        com.codeanalysis.algs4.StdOut.printf("    stddev %10.3f\n", stddev(a));
        com.codeanalysis.algs4.StdOut.printf("       var %10.3f\n", var(a));
        com.codeanalysis.algs4.StdOut.printf("   stddevp %10.3f\n", stddevp(a));
