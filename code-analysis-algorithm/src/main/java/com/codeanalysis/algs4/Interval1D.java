...
public class Interval1D {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < intervals.length; i++)
            com.codeanalysis.algs4.StdOut.println(intervals[i]);
        com.codeanalysis.algs4.StdOut.println();
        
        com.codeanalysis.algs4.StdOut.println("Sort by min endpoint");
        Arrays.sort(intervals, Interval1D.MIN_ENDPOINT_ORDER);
        for (int i = 0; i < intervals.length; i++)
            com.codeanalysis.algs4.StdOut.println(intervals[i]);
        com.codeanalysis.algs4.StdOut.println();

        com.codeanalysis.algs4.StdOut.println("Sort by max endpoint");
        Arrays.sort(intervals, Interval1D.MAX_ENDPOINT_ORDER);
        for (int i = 0; i < intervals.length; i++)
            com.codeanalysis.algs4.StdOut.println(intervals[i]);
        com.codeanalysis.algs4.StdOut.println();

        com.codeanalysis.algs4.StdOut.println("Sort by length");
