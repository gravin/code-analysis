...
public class NFA { 
    ...
    public NFA(String regexp) {
        this.regexp = regexp;
        m = regexp.length();
        com.codeanalysis.algs4.Stack<Integer> ops = new Stack<Integer>();
    ...
    public boolean recognizes(String txt) {
        ...
        com.codeanalysis.algs4.Bag<Integer> pc = new com.codeanalysis.algs4.Bag<Integer>();
        ...
        for (int i = 0; i < txt.length(); i++) {
            ...
            com.codeanalysis.algs4.Bag<Integer> match = new com.codeanalysis.algs4.Bag<Integer>();
            for (int v : pc) {
                if (v == m) continue;
