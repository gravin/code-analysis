...
public class Complex {
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.StdOut.println("a            = " + a);
        com.codeanalysis.algs4.StdOut.println("b            = " + b);
        com.codeanalysis.algs4.StdOut.println("Re(a)        = " + a.re());
        com.codeanalysis.algs4.StdOut.println("Im(a)        = " + a.im());
        com.codeanalysis.algs4.StdOut.println("b + a        = " + b.plus(a));
        com.codeanalysis.algs4.StdOut.println("a - b        = " + a.minus(b));
        com.codeanalysis.algs4.StdOut.println("a * b        = " + a.times(b));
        com.codeanalysis.algs4.StdOut.println("b * a        = " + b.times(a));
        com.codeanalysis.algs4.StdOut.println("a / b        = " + a.divides(b));
        com.codeanalysis.algs4.StdOut.println("(a / b) * b  = " + a.divides(b).times(b));
        com.codeanalysis.algs4.StdOut.println("conj(a)      = " + a.conjugate());
        com.codeanalysis.algs4.StdOut.println("|a|          = " + a.abs());
