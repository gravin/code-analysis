...
public class TrieSET implements Iterable<String> {
    ...
    public Iterable<String> keysWithPrefix(String prefix) {
        com.codeanalysis.algs4.Queue<String> results = new com.codeanalysis.algs4.Queue<String>();
        Node x = get(root, prefix, 0);
        collect(x, new StringBuilder(prefix), results);
        return results;
    }

    private void collect(Node x, StringBuilder prefix, com.codeanalysis.algs4.Queue<String> results) {
        if (x == null) return;
    ...
    public static void main(String[] args) {
        ...
        while (!com.codeanalysis.algs4.StdIn.isEmpty()) {
        ...
        // print results
        if (set.size() < 100) {
            com.codeanalysis.algs4.StdOut.println("keys(\"\"):");
            for (String key : set) {
                com.codeanalysis.algs4.StdOut.println(key);
            }
            com.codeanalysis.algs4.StdOut.println();
        }

        com.codeanalysis.algs4.StdOut.println("longestPrefixOf(\"shellsort\"):");
        com.codeanalysis.algs4.StdOut.println(set.longestPrefixOf("shellsort"));
        com.codeanalysis.algs4.StdOut.println();

        com.codeanalysis.algs4.StdOut.println("longestPrefixOf(\"xshellsort\"):");
        com.codeanalysis.algs4.StdOut.println(set.longestPrefixOf("xshellsort"));
        com.codeanalysis.algs4.StdOut.println();

        com.codeanalysis.algs4.StdOut.println("keysWithPrefix(\"shor\"):");
        for (String s : set.keysWithPrefix("shor"))
            com.codeanalysis.algs4.StdOut.println(s);
        com.codeanalysis.algs4.StdOut.println();

        com.codeanalysis.algs4.StdOut.println("keysWithPrefix(\"shortening\"):");
        for (String s : set.keysWithPrefix("shortening"))
            com.codeanalysis.algs4.StdOut.println(s);
        com.codeanalysis.algs4.StdOut.println();

        com.codeanalysis.algs4.StdOut.println("keysThatMatch(\".he.l.\"):");
