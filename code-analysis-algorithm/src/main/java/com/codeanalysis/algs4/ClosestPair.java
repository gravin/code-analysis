...
import com.codeanalysis.algs4.FarthestPair;
...
public class ClosestPair {
     ...
     */
    public ClosestPair(com.codeanalysis.algs4.Point2D[] points) {
        ...
        com.codeanalysis.algs4.Point2D[] pointsByX = new com.codeanalysis.algs4.Point2D[n];
        for (int i = 0; i < n; i++)
            pointsByX[i] = points[i];
        Arrays.sort(pointsByX, com.codeanalysis.algs4.Point2D.X_ORDER);
        ...
        com.codeanalysis.algs4.Point2D[] pointsByY = new com.codeanalysis.algs4.Point2D[n];
        for (int i = 0; i < n; i++)
            pointsByY[i] = pointsByX[i];

        // auxiliary array
        com.codeanalysis.algs4.Point2D[] aux = new com.codeanalysis.algs4.Point2D[n];
    ...
    private double closest(com.codeanalysis.algs4.Point2D[] pointsByX, com.codeanalysis.algs4.Point2D[] pointsByY, com.codeanalysis.algs4.Point2D[] aux, int lo, int hi) {
        if (hi <= lo) return Double.POSITIVE_INFINITY;

        int mid = lo + (hi - lo) / 2;
        com.codeanalysis.algs4.Point2D median = pointsByX[mid];
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            double x = com.codeanalysis.algs4.StdIn.readDouble();
