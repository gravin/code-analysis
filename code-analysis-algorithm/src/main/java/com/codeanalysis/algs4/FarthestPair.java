...
import com.codeanalysis.algs4.ClosestPair;
import com.codeanalysis.algs4.GrahamScan;
 ...
 *  See also {@link ClosestPair} and {@link com.codeanalysis.algs4.GrahamScan}.
 *  <p>
...
public class FarthestPair {
    ...
    private com.codeanalysis.algs4.Point2D best1, best2;
     ...
     */
    public FarthestPair(com.codeanalysis.algs4.Point2D[] points) {
        ...
        com.codeanalysis.algs4.GrahamScan graham = new GrahamScan(points);
        ...
        int m = 0;
        for (com.codeanalysis.algs4.Point2D p : graham.hull())
            m++;

        // the hull, in counterclockwise order hull[1] to hull[m]
        com.codeanalysis.algs4.Point2D[] hull = new com.codeanalysis.algs4.Point2D[m+1];
        m = 1;
        for (com.codeanalysis.algs4.Point2D p : graham.hull()) {
            hull[m++] = p;
        }
        ...
        int k = 2;
        while (com.codeanalysis.algs4.Point2D.area2(hull[m], hull[1], hull[k+1]) > com.codeanalysis.algs4.Point2D.area2(hull[m], hull[1], hull[k])) {
            k++;
        }
        ...
        for (int i = 1; i <= k && j <= m; i++) {
            ...
            while ((j < m) && com.codeanalysis.algs4.Point2D.area2(hull[i], hull[i+1], hull[j+1]) > com.codeanalysis.algs4.Point2D.area2(hull[i], hull[i+1], hull[j])) {
                j++;
                // StdOut.println(hull[i] + " and " + hull[j] + " are antipodal");
     ...
     */
    public com.codeanalysis.algs4.Point2D either() {
        return best1;
    }
     ...
     *         {@code null} if no such point (because there are fewer than 2 points)
     */
    public com.codeanalysis.algs4.Point2D other() {
        return best2;
    }
