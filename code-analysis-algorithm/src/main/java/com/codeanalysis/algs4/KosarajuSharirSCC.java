...
import com.codeanalysis.algs4.DepthFirstOrder;
import com.codeanalysis.algs4.Digraph;
import com.codeanalysis.algs4.GabowSCC;
...
public class KosarajuSharirSCC {
     ...
     * @param G the digraph
     */
    public KosarajuSharirSCC(com.codeanalysis.algs4.Digraph G) {

        // compute reverse postorder of reverse graph
        com.codeanalysis.algs4.DepthFirstOrder dfs = new DepthFirstOrder(G.reverse());
    ...
    public static void main(String[] args) {
        ...
        int m = scc.count();
        com.codeanalysis.algs4.StdOut.println(m + " strong components");
