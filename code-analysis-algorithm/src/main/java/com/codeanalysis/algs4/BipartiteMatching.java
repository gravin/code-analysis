...
import com.codeanalysis.algs4.BipartiteX;
import com.codeanalysis.algs4.Graph;
import com.codeanalysis.algs4.GraphGenerator;
import com.codeanalysis.algs4.HopcroftKarp;
...
public class BipartiteMatching {
    ...
    private com.codeanalysis.algs4.BipartiteX bipartition;      // the bipartition
     ...
     */
    public BipartiteMatching(com.codeanalysis.algs4.Graph G) {
     ...
     */
    private boolean hasAugmentingPath(com.codeanalysis.algs4.Graph G) {
    ...
    public static void main(String[] args) {
        ...
        if (G.V() < 1000) com.codeanalysis.algs4.StdOut.println(G);

        BipartiteMatching matching = new BipartiteMatching(G);
        
        // print maximum matching
        com.codeanalysis.algs4.StdOut.printf("Number of edges in max matching        = %d\n", matching.size());
        com.codeanalysis.algs4.StdOut.printf("Number of vertices in min vertex cover = %d\n", matching.size());
        com.codeanalysis.algs4.StdOut.printf("Graph has a perfect matching           = %b\n", matching.isPerfect());
        com.codeanalysis.algs4.StdOut.println();

        if (G.V() >= 1000) return;

        com.codeanalysis.algs4.StdOut.print("Max matching: ");
        for (int v = 0; v < G.V(); v++) {
            int w = matching.mate(v);
            if (matching.isMatched(v) && v < w)  // print each edge only once
                com.codeanalysis.algs4.StdOut.print(v + "-" + w + " ");
        }
        com.codeanalysis.algs4.StdOut.println();

        // print minimum vertex cover
        com.codeanalysis.algs4.StdOut.print("Min vertex cover: ");
        for (int v = 0; v < G.V(); v++)
