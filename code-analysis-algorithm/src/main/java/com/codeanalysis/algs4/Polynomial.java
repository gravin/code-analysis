...
public class Polynomial {
    ...
    public static void main(String[] args) { 
        ...
        com.codeanalysis.algs4.StdOut.println("zero(x)     = " + zero);
        com.codeanalysis.algs4.StdOut.println("p(x)        = " + p);
        com.codeanalysis.algs4.StdOut.println("q(x)        = " + q);
        com.codeanalysis.algs4.StdOut.println("p(x) + q(x) = " + r);
        com.codeanalysis.algs4.StdOut.println("p(x) * q(x) = " + s);
        com.codeanalysis.algs4.StdOut.println("p(q(x))     = " + t);
        com.codeanalysis.algs4.StdOut.println("p(x) - p(x) = " + u);
        com.codeanalysis.algs4.StdOut.println("0 - p(x)    = " + zero.minus(p));
        com.codeanalysis.algs4.StdOut.println("p(3)        = " + p.evaluate(3));
        com.codeanalysis.algs4.StdOut.println("p'(x)       = " + p.differentiate());
