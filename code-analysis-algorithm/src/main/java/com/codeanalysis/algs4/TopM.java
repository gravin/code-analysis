 ...
 *  to standard output. This implementation uses a {@link com.codeanalysis.algs4.MinPQ} of size
 *  at most <em>m</em> + 1 to identify the <em>M</em> largest transactions
 *  and a {@link com.codeanalysis.algs4.Stack} to output them in the proper order.
 *  <p>
...
public class TopM {   
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.MinPQ<Transaction> pq = new MinPQ<Transaction>(m+1);
        ...
        com.codeanalysis.algs4.Stack<Transaction> stack = new Stack<Transaction>();
