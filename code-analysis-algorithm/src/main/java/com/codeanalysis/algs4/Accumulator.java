...
public class Accumulator {
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.StdOut.printf("n      = %d\n",   stats.count());
        com.codeanalysis.algs4.StdOut.printf("mean   = %.5f\n", stats.mean());
        com.codeanalysis.algs4.StdOut.printf("stddev = %.5f\n", stats.stddev());
        com.codeanalysis.algs4.StdOut.printf("var    = %.5f\n", stats.var());
