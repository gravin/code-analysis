...
import com.codeanalysis.algs4.Date;
...
public class Transaction implements Comparable<Transaction> {
    ...
    private final com.codeanalysis.algs4.Date when;     // date
     ...
     */
    public Transaction(String who, com.codeanalysis.algs4.Date when, double amount) {
    ...
    public Transaction(String transaction) {
        ...
        who    = a[0];
        when   = new com.codeanalysis.algs4.Date(a[1]);
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.StdOut.println("Unsorted");
        for (int i = 0; i < a.length; i++)
            com.codeanalysis.algs4.StdOut.println(a[i]);
        com.codeanalysis.algs4.StdOut.println();
        
        com.codeanalysis.algs4.StdOut.println("Sort by date");
        Arrays.sort(a, new WhenOrder());
        for (int i = 0; i < a.length; i++)
            com.codeanalysis.algs4.StdOut.println(a[i]);
        com.codeanalysis.algs4.StdOut.println();

        com.codeanalysis.algs4.StdOut.println("Sort by customer");
        Arrays.sort(a, new WhoOrder());
        for (int i = 0; i < a.length; i++)
            com.codeanalysis.algs4.StdOut.println(a[i]);
        com.codeanalysis.algs4.StdOut.println();

        com.codeanalysis.algs4.StdOut.println("Sort by amount");
