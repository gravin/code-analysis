...
import com.codeanalysis.algs4.DepthFirstPaths;
import com.codeanalysis.algs4.Graph;
import com.codeanalysis.algs4.In;
import com.codeanalysis.algs4.NonrecursiveDFS;
...
public class DepthFirstSearch {
     ...
     */
    public DepthFirstSearch(com.codeanalysis.algs4.Graph G, int s) {
    ...
    private void dfs(com.codeanalysis.algs4.Graph G, int v) {
        count++;
        marked[v] = true;
        for (int w : G.adj(v)) {
            if (!marked[w]) {
    ...
    public static void main(String[] args) {
        ...
        if (search.count() != G.V()) com.codeanalysis.algs4.StdOut.println("NOT connected");
