...
import com.codeanalysis.algs4.LongestCommonSubstring;
import com.codeanalysis.algs4.StdIn;
import com.codeanalysis.algs4.StdOut;
import com.codeanalysis.algs4.SuffixArray;

/**
 *  The {@code LongestRepeatedSubstring} class provides a {@link com.codeanalysis.algs4.SuffixArray}
...
public class LongestRepeatedSubstring {
    ...
    public static String lrs(String text) {
        int n = text.length();
        com.codeanalysis.algs4.SuffixArray sa = new SuffixArray(text);
        String lrs = "";
        for (int i = 1; i < n; i++) {
            int length = sa.lcp(i);
