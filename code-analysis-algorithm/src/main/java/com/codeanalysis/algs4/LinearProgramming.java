   ...
   // index of a non-basic column with most positive cost
    ...
    private boolean isPrimalFeasible(double[][] A, double[] b) {
        ...
        for (int j = 0; j < x.length; j++) {
            if (x[j] < 0.0) {
                com.codeanalysis.algs4.StdOut.println("x[" + j + "] = " + x[j] + " is negative");
                return false;
            }
        }
        ...
        for (int i = 0; i < m; i++) {
            ...
            if (sum > b[i] + EPSILON) {
                com.codeanalysis.algs4.StdOut.println("not primal feasible");
                com.codeanalysis.algs4.StdOut.println("b[" + i + "] = " + b[i] + ", sum = " + sum);
                return false;
            }
        }
        return true;
    ...
    private boolean isDualFeasible(double[][] A, double[] c) {
        ...
        for (int i = 0; i < y.length; i++) {
            if (y[i] < 0.0) {
                com.codeanalysis.algs4.StdOut.println("y[" + i + "] = " + y[i] + " is negative");
                return false;
            }
        }
        ...
        for (int j = 0; j < n; j++) {
            ...
            if (sum < c[j] - EPSILON) {
                com.codeanalysis.algs4.StdOut.println("not dual feasible");
                com.codeanalysis.algs4.StdOut.println("c[" + j + "] = " + c[j] + ", sum = " + sum);
                return false;
            }
        }
        return true;
    ...
    private boolean isOptimal(double[] b, double[] c) {
        ...
        if (Math.abs(value - value1) > EPSILON || Math.abs(value - value2) > EPSILON) {
            com.codeanalysis.algs4.StdOut.println("value = " + value + ", cx = " + value1 + ", yb = " + value2);
            return false;
        }
    ...
    // print tableaux
    private void show() {
        com.codeanalysis.algs4.StdOut.println("m = " + m);
        com.codeanalysis.algs4.StdOut.println("n = " + n);
        for (int i = 0; i <= m; i++) {
            for (int j = 0; j <= m+n; j++) {
                com.codeanalysis.algs4.StdOut.printf("%7.2f ", a[i][j]);
                // StdOut.printf("%10.7f ", a[i][j]);
            }
            com.codeanalysis.algs4.StdOut.println();
        }
        com.codeanalysis.algs4.StdOut.println("value = " + value());
        for (int i = 0; i < m; i++)
            if (basis[i] < n) com.codeanalysis.algs4.StdOut.println("x_" + basis[i] + " = " + a[i][m+n]);
        com.codeanalysis.algs4.StdOut.println();
    }
    ...
    private static void test(double[][] A, double[] b, double[] c) {
        ...
        com.codeanalysis.algs4.StdOut.println("value = " + lp.value());
        double[] x = lp.primal();
        for (int i = 0; i < x.length; i++)
            com.codeanalysis.algs4.StdOut.println("x[" + i + "] = " + x[i]);
        double[] y = lp.dual();
        for (int j = 0; j < y.length; j++)
            com.codeanalysis.algs4.StdOut.println("y[" + j + "] = " + y[j]);
    }
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.StdOut.println("----- test 1 --------------------");
        test1();
        com.codeanalysis.algs4.StdOut.println();

        com.codeanalysis.algs4.StdOut.println("----- test 2 --------------------");
        test2();
        com.codeanalysis.algs4.StdOut.println();

        com.codeanalysis.algs4.StdOut.println("----- test 3 --------------------");
        test3();
        com.codeanalysis.algs4.StdOut.println();

        com.codeanalysis.algs4.StdOut.println("----- test 4 --------------------");
        test4();
        com.codeanalysis.algs4.StdOut.println();
        ...
        for (int j = 0; j < n; j++)
            c[j] = com.codeanalysis.algs4.StdRandom.uniform(1000);
        for (int i = 0; i < m; i++)
            b[i] = com.codeanalysis.algs4.StdRandom.uniform(1000);
        for (int i = 0; i < m; i++)
            for (int j = 0; j < n; j++)
