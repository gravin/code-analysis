...
import com.codeanalysis.algs4.BreadthFirstPaths;
import com.codeanalysis.algs4.Digraph;
import com.codeanalysis.algs4.DigraphGenerator;
import com.codeanalysis.algs4.DirectedEulerianCycle;
import com.codeanalysis.algs4.EulerianCycle;
import com.codeanalysis.algs4.EulerianPath;
import com.codeanalysis.algs4.Graph;
import com.codeanalysis.algs4.In;
...
public class DirectedEulerianPath {
    private com.codeanalysis.algs4.Stack<Integer> path = null;   // Eulerian path; null if no suh path
     ...
     * @param G the digraph
     */
    public DirectedEulerianPath(com.codeanalysis.algs4.Digraph G) {
        ...
        com.codeanalysis.algs4.Stack<Integer> stack = new com.codeanalysis.algs4.Stack<Integer>();
        stack.push(s);
    ...
    private static int nonIsolatedVertex(com.codeanalysis.algs4.Digraph G) {
        for (int v = 0; v < G.V(); v++)
            if (G.outdegree(v) > 0)
                return v;
        return -1;
    ...
    private static boolean satisfiesNecessaryAndSufficientConditions(com.codeanalysis.algs4.Digraph G) {
        ...
        com.codeanalysis.algs4.Graph H = new Graph(G.V());
        for (int v = 0; v < G.V(); v++)
            for (int w : G.adj(v))
                H.addEdge(v, w);
        ...
        int s = nonIsolatedVertex(G);
        com.codeanalysis.algs4.BreadthFirstPaths bfs = new BreadthFirstPaths(H, s);
        for (int v = 0; v < G.V(); v++)
    ...
    private boolean check(com.codeanalysis.algs4.Digraph G) {
    ...
    private static void unitTest(com.codeanalysis.algs4.Digraph G, String description) {
        com.codeanalysis.algs4.StdOut.println(description);
        com.codeanalysis.algs4.StdOut.println("-------------------------------------");
        com.codeanalysis.algs4.StdOut.print(G);

        DirectedEulerianPath euler = new DirectedEulerianPath(G);

        com.codeanalysis.algs4.StdOut.print("Eulerian path:  ");
        if (euler.hasEulerianPath()) {
            for (int v : euler.path()) {
                com.codeanalysis.algs4.StdOut.print(v + " ");
            }
            com.codeanalysis.algs4.StdOut.println();
        }
        else {
            com.codeanalysis.algs4.StdOut.println("none");
        }
        StdOut.println();
    }
    ...
    public static void main(String[] args) {
        ...
        // Eulerian cycle
        com.codeanalysis.algs4.Digraph G1 = com.codeanalysis.algs4.DigraphGenerator.eulerianCycle(V, E);
        unitTest(G1, "Eulerian cycle");

        // Eulerian path
        com.codeanalysis.algs4.Digraph G2 = com.codeanalysis.algs4.DigraphGenerator.eulerianPath(V, E);
        unitTest(G2, "Eulerian path");

        // add one random edge
        com.codeanalysis.algs4.Digraph G3 = new com.codeanalysis.algs4.Digraph(G2);
        G3.addEdge(com.codeanalysis.algs4.StdRandom.uniform(V), com.codeanalysis.algs4.StdRandom.uniform(V));
        unitTest(G3, "one random edge added to Eulerian path");

        // self loop
        com.codeanalysis.algs4.Digraph G4 = new com.codeanalysis.algs4.Digraph(V);
        int v4 = com.codeanalysis.algs4.StdRandom.uniform(V);
        G4.addEdge(v4, v4);
        unitTest(G4, "single self loop");

        // single edge
        com.codeanalysis.algs4.Digraph G5 = new com.codeanalysis.algs4.Digraph(V);
        G5.addEdge(com.codeanalysis.algs4.StdRandom.uniform(V), StdRandom.uniform(V));
        unitTest(G5, "single edge");

        // empty digraph
        com.codeanalysis.algs4.Digraph G6 = new com.codeanalysis.algs4.Digraph(V);
        unitTest(G6, "empty digraph");

        // random digraph
        com.codeanalysis.algs4.Digraph G7 = DigraphGenerator.simple(V, E);
        unitTest(G7, "simple digraph");

        // 4-vertex digraph
        com.codeanalysis.algs4.Digraph G8 = new Digraph(new In("eulerianD.txt"));
