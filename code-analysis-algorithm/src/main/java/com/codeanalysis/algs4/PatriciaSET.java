...
public class PatriciaSET implements Iterable<String> {
    ...
    public Iterator<String> iterator() {
        com.codeanalysis.algs4.Queue<String> queue = new com.codeanalysis.algs4.Queue<String>();
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            com.codeanalysis.algs4.StdOut.printf("Creating dataset (%d items)...\n", limitItem);
            for (int i = 0; i < limitItem; i++)
                a[i] = Integer.toString(i, 16);

            com.codeanalysis.algs4.StdOut.printf("Shuffling...\n");
            com.codeanalysis.algs4.StdRandom.shuffle(a);

            com.codeanalysis.algs4.StdOut.printf("Adding (%d items)...\n", limitItem);
            for (int i = 0; i < limitItem; i++)
                set.add(a[i]);

            int countItems = 0;
            com.codeanalysis.algs4.StdOut.printf("Iterating...\n");
            for (String key : set) countItems++;
            com.codeanalysis.algs4.StdOut.printf("%d items iterated\n", countItems);
            ...
            com.codeanalysis.algs4.StdOut.printf("Deleting (%d items)...\n", limitDelete);
            ...
            int countDelete = 0;
            int countRemain = 0;
            com.codeanalysis.algs4.StdOut.printf("Checking...\n");
            for (int i = 0; i < limitItem; i++) {
                if (i < limitDelete) {
            ...
            com.codeanalysis.algs4.StdOut.printf("%d items found and %d (deleted) items missing\n",
            ...
            com.codeanalysis.algs4.StdOut.printf("Deleting the rest (%d items)...\n",
            ...
            countPass++;
            if (ok) com.codeanalysis.algs4.StdOut.printf("PASS %d TESTS SUCCEEDED\n", countPass);
