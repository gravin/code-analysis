...
import com.codeanalysis.algs4.BinaryDump;
import com.codeanalysis.algs4.BinaryStdIn;
import com.codeanalysis.algs4.PictureDump;
...
public class HexDump {
    ...
    public static void main(String[] args) {
        ...
        for (i = 0; !BinaryStdIn.isEmpty(); i++) {
            ...
            if (i == 0) com.codeanalysis.algs4.StdOut.printf("");
            else if (i % bytesPerLine == 0) com.codeanalysis.algs4.StdOut.printf("\n", i);
            else com.codeanalysis.algs4.StdOut.print(" ");
            char c = BinaryStdIn.readChar();
            com.codeanalysis.algs4.StdOut.printf("%02x", c & 0xff);
        }
        if (bytesPerLine != 0) com.codeanalysis.algs4.StdOut.println();
