 ...
 *  edge is of type {@link com.codeanalysis.algs4.FlowEdge} and has a real-valued capacity
 *  and flow.
...
public class FlowNetwork {
    ...
    private final int V;
    private int E;
    private com.codeanalysis.algs4.Bag<com.codeanalysis.algs4.FlowEdge>[] adj;
    ...
    public FlowNetwork(int V) {
        ...
        this.V = V;
        this.E = 0;
        adj = (com.codeanalysis.algs4.Bag<com.codeanalysis.algs4.FlowEdge>[]) new com.codeanalysis.algs4.Bag[V];
        for (int v = 0; v < V; v++)
            adj[v] = new com.codeanalysis.algs4.Bag<com.codeanalysis.algs4.FlowEdge>();
    }
    ...
    public FlowNetwork(int V, int E) {
        ...
        for (int i = 0; i < E; i++) {
            ...
            addEdge(new com.codeanalysis.algs4.FlowEdge(v, w, capacity));
        }
    }
     ...
     */
    public FlowNetwork(com.codeanalysis.algs4.In in) {
        this(in.readInt());
        int E = in.readInt();
        if (E < 0) throw new IllegalArgumentException("number of edges must be nonnegative");
        for (int i = 0; i < E; i++) {
     ...
     *         {@code 0} and {@code V-1}
     */
    public void addEdge(com.codeanalysis.algs4.FlowEdge e) {
        int v = e.from();
        int w = e.to();
        validateVertex(v);
        validateVertex(w);
     ...
     */
    public Iterable<com.codeanalysis.algs4.FlowEdge> adj(int v) {
        validateVertex(v);
        return adj[v];
    }

    // return list of all edges - excludes self loops
    public Iterable<com.codeanalysis.algs4.FlowEdge> edges() {
        com.codeanalysis.algs4.Bag<com.codeanalysis.algs4.FlowEdge> list = new Bag<com.codeanalysis.algs4.FlowEdge>();
        for (int v = 0; v < V; v++)
            for (com.codeanalysis.algs4.FlowEdge e : adj(v)) {
                if (e.to() != v)
                    list.add(e);
            }
        return list;
