...
import com.codeanalysis.algs4.AVLTreeST;
...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
    ...
    public Iterable<Key> keys() {
        if (isEmpty()) return new com.codeanalysis.algs4.Queue<Key>();
        return keys(min(), max());
    }
    ...
    ***************************************************************************/
    private boolean check() {
        if (!isBST())            com.codeanalysis.algs4.StdOut.println("Not in symmetric order");
        ...
        if (!is23())             com.codeanalysis.algs4.StdOut.println("Not a 2-3 tree");
        if (!isBalanced())       com.codeanalysis.algs4.StdOut.println("Not balanced");
