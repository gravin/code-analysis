...
public class TopologicalX {
    private com.codeanalysis.algs4.Queue<Integer> order;     // vertices in topological order
     ...
     * @param G the digraph
     */
    public TopologicalX(com.codeanalysis.algs4.Digraph G) {
        ...
        // initialize 
        ranks = new int[G.V()]; 
        order = new com.codeanalysis.algs4.Queue<Integer>();
        int count = 0;

        // initialize queue to contain all vertices with indegree = 0
        com.codeanalysis.algs4.Queue<Integer> queue = new com.codeanalysis.algs4.Queue<Integer>();
        for (int v = 0; v < G.V(); v++)
    ...
    public static void main(String[] args) {
        ...
        for (int v = 0; v < G1.V(); v++)
            for (int w : G1.adj(v))
                G2.addEdge(new com.codeanalysis.algs4.DirectedEdge(v, w, 0.0));
        ...
        com.codeanalysis.algs4.StdOut.println(G1);
        com.codeanalysis.algs4.StdOut.println();
        com.codeanalysis.algs4.StdOut.println(G2);

        // find a directed cycle
        TopologicalX topological1 = new TopologicalX(G1);
        if (!topological1.hasOrder()) {
            com.codeanalysis.algs4.StdOut.println("Not a DAG");
        }

        // or give topologial sort
        else {
            com.codeanalysis.algs4.StdOut.print("Topological order: ");
