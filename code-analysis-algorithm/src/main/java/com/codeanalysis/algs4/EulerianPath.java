...
public class EulerianPath {
     ...
     * @param G the graph
     */
    public EulerianPath(com.codeanalysis.algs4.Graph G) {
    ...
    public static void main(String[] args) {
        ...
        // add one random edge
        com.codeanalysis.algs4.Graph G3 = new com.codeanalysis.algs4.Graph(G2);
        ...
        // empty graph
        com.codeanalysis.algs4.Graph G6 = new com.codeanalysis.algs4.Graph(V);
