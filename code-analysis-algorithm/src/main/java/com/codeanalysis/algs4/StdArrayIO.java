...
public class StdArrayIO {
    ...
    public static double[] readDouble1D() {
        ...
        for (int i = 0; i < n; i++) {
            a[i] = com.codeanalysis.algs4.StdIn.readDouble();
        }
        return a;
    }
    ...
    public static void print(double[] a) {
        int n = a.length;
        com.codeanalysis.algs4.StdOut.println(n);
        for (int i = 0; i < n; i++) {
            com.codeanalysis.algs4.StdOut.printf("%9.5f ", a[i]);
        }
    ...
    public static double[][] readDouble2D() {
        int m = com.codeanalysis.algs4.StdIn.readInt();
        int n = com.codeanalysis.algs4.StdIn.readInt();
        double[][] a = new double[m][n];
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                a[i][j] = com.codeanalysis.algs4.StdIn.readDouble();
            }
        }
        return a;
    }
    ...
    public static void print(double[][] a) {
        int m = a.length;
        int n = a[0].length;
        com.codeanalysis.algs4.StdOut.println(m + " " + n);
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                com.codeanalysis.algs4.StdOut.printf("%9.5f ", a[i][j]);
            }
            com.codeanalysis.algs4.StdOut.println();
        }
    }
    ...
    public static int[] readInt1D() {
        ...
        int[] a = new int[n];
        for (int i = 0; i < n; i++) {
            a[i] = com.codeanalysis.algs4.StdIn.readInt();
        }
        return a;
    }
    ...
    public static void print(int[] a) {
        ...
        com.codeanalysis.algs4.StdOut.println(n);
        for (int i = 0; i < n; i++) {
            com.codeanalysis.algs4.StdOut.printf("%9d ", a[i]);
        }
        com.codeanalysis.algs4.StdOut.println();
    }
    ...
    public static int[][] readInt2D() {
        ...
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                a[i][j] = com.codeanalysis.algs4.StdIn.readInt();
            }
        }
        return a;
    }
    ...
    public static void print(int[][] a) {
        ...
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                com.codeanalysis.algs4.StdOut.printf("%9d ", a[i][j]);
            }
            com.codeanalysis.algs4.StdOut.println();
        }
    }
    ...
    public static boolean[] readBoolean1D() {
        ...
        for (int i = 0; i < n; i++) {
            a[i] = com.codeanalysis.algs4.StdIn.readBoolean();
        }
        return a;
    }
    ...
    public static void print(boolean[] a) {
        ...
        com.codeanalysis.algs4.StdOut.println(n);
        for (int i = 0; i < n; i++) {
            if (a[i]) com.codeanalysis.algs4.StdOut.print("1 ");
            else      com.codeanalysis.algs4.StdOut.print("0 ");
        }
        com.codeanalysis.algs4.StdOut.println();
    }
   ...
   /**
    ...
    public static void print(boolean[][] a) {
        ...
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                if (a[i][j]) com.codeanalysis.algs4.StdOut.print("1 ");
                else         com.codeanalysis.algs4.StdOut.print("0 ");
            }
            com.codeanalysis.algs4.StdOut.println();
        }
