...
import com.codeanalysis.algs4.SymbolGraph;
...
public class DegreesOfSeparation {
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.SymbolGraph sg = new SymbolGraph(filename, delimiter);
        Graph G = sg.graph();
        if (!sg.contains(source)) {
            com.codeanalysis.algs4.StdOut.println(source + " not in database.");
            return;
        }
            ...
            if (sg.contains(sink)) {
                ...
                if (bfs.hasPathTo(t)) {
                    for (int v : bfs.pathTo(t)) {
                        com.codeanalysis.algs4.StdOut.println("   " + sg.nameOf(v));
                    }
                }
                else {
                    com.codeanalysis.algs4.StdOut.println("Not connected");
                }
            }
            else {
