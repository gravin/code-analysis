...
import com.codeanalysis.algs4.AmericanFlagX;
...
public class AmericanFlag {
    ...
    public static void sort(String[] a, int lo, int hi) {
        ...
        com.codeanalysis.algs4.Stack<Integer> st = new com.codeanalysis.algs4.Stack<Integer>();
   ...
   /**
    ...
    private static void sort(int[] a, int lo, int hi) {
        // one-time allocation of data structures
        com.codeanalysis.algs4.Stack<Integer> st = new Stack<Integer>();
    ...
    public static void main(String[] args) {
        if (args.length > 0 && args[0].equals("int")) {
            int[] a = com.codeanalysis.algs4.StdIn.readAllInts();
            sort(a);
