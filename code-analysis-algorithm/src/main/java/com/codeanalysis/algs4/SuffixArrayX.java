...
import com.codeanalysis.algs4.SuffixArray;
 ...
 *  {@link com.codeanalysis.algs4.SuffixArray}.
...
public class SuffixArrayX {
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.SuffixArray suffix2 = new SuffixArray(s);
        boolean check = true;
        for (int i = 0; check && i < s.length(); i++) {
            if (suffix1.index(i) != suffix2.index(i)) {
                com.codeanalysis.algs4.StdOut.println("suffix1(" + i + ") = " + suffix1.index(i));
                com.codeanalysis.algs4.StdOut.println("suffix2(" + i + ") = " + suffix2.index(i));
                ...
                com.codeanalysis.algs4.StdOut.println(ith);
                com.codeanalysis.algs4.StdOut.println(jth);
                check = false;
            }
        }

        com.codeanalysis.algs4.StdOut.println("  i ind lcp rnk  select");
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (i == 0) {
                com.codeanalysis.algs4.StdOut.printf("%3d %3d %3s %3d  %s\n", i, index, "-", rank, ith);
            }
            else {
