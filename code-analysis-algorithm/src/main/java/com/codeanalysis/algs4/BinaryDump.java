...
import com.codeanalysis.algs4.HexDump;
...
public class BinaryDump {
    ...
    public static void main(String[] args) {
        ...
        for (count = 0; !BinaryStdIn.isEmpty(); count++) {
            ...
            else if (count != 0 && count % bitsPerLine == 0) com.codeanalysis.algs4.StdOut.println();
            if (BinaryStdIn.readBoolean()) com.codeanalysis.algs4.StdOut.print(1);
            else                           com.codeanalysis.algs4.StdOut.print(0);
        }
        if (bitsPerLine != 0) com.codeanalysis.algs4.StdOut.println();
