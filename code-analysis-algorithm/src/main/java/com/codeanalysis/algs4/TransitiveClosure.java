...
import com.codeanalysis.algs4.DirectedDFS;
...
public class TransitiveClosure {
    private com.codeanalysis.algs4.DirectedDFS[] tc;  // tc[v] = reachable from v

    /**
     * Computes the transitive closure of the digraph {@code G}.
     * @param G the digraph
     */
    public TransitiveClosure(com.codeanalysis.algs4.Digraph G) {
        tc = new com.codeanalysis.algs4.DirectedDFS[G.V()];
        for (int v = 0; v < G.V(); v++)
    ...
    public static void main(String[] args) {
        ...
        // print header
        com.codeanalysis.algs4.StdOut.print("     ");
        for (int v = 0; v < G.V(); v++)
        ...
        for (int v = 0; v < G.V(); v++) {
            com.codeanalysis.algs4.StdOut.printf("%3d: ", v);
            for (int w = 0; w < G.V(); w++) {
                if (tc.reachable(v, w)) com.codeanalysis.algs4.StdOut.printf("  T");
                else                    com.codeanalysis.algs4.StdOut.printf("   ");
            }
            StdOut.println();
        }
    }
