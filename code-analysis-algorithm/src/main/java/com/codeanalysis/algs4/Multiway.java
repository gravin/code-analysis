...
public class Multiway { 
    ...
    private static void merge(com.codeanalysis.algs4.In[] streams) {
        ...
        while (!pq.isEmpty()) {
            com.codeanalysis.algs4.StdOut.print(pq.minKey() + " ");
            int i = pq.delMin();
            if (!streams[i].isEmpty())
                pq.insert(i, streams[i].readString());
        }
    ...
    public static void main(String[] args) {
        int n = args.length;
        com.codeanalysis.algs4.In[] streams = new com.codeanalysis.algs4.In[n];
        for (int i = 0; i < n; i++)
