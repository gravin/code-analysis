    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if ((!line[0].equals("set") && !line[0].equals("init")) && st == null) {
                com.codeanalysis.algs4.StdOut.println("Segment Tree not initialized");
                continue;
            }
            int array[];
            if (line[0].equals("set")) {
                ...
                for (int i = 0; i < st.size(); i++) {
                    com.codeanalysis.algs4.StdOut.print(st.rsq(i, i) + " ");
                }
                ...
                com.codeanalysis.algs4.StdOut.printf("Sum from %d to %d = %d%n", arg1, arg2, st.rsq(arg1, arg2));
            }
            else if (line[0].equals("rmq")) {
                com.codeanalysis.algs4.StdOut.printf("Min from %d to %d = %d%n", arg1, arg2, st.rMinQ(arg1, arg2));
            }
            else {
