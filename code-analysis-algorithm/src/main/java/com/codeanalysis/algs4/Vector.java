...
public class Vector { 
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.StdOut.println("   x       = " + x);
        com.codeanalysis.algs4.StdOut.println("   y       = " + y);

        Vector z = x.plus(y);
        com.codeanalysis.algs4.StdOut.println("   z       = " + z);

        z = z.times(10.0);
        com.codeanalysis.algs4.StdOut.println(" 10z       = " + z);

        com.codeanalysis.algs4.StdOut.println("  |x|      = " + x.magnitude());
        com.codeanalysis.algs4.StdOut.println(" <x, y>    = " + x.dot(y));
        com.codeanalysis.algs4.StdOut.println("dist(x, y) = " + x.distanceTo(y));
