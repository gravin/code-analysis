...
import com.codeanalysis.algs4.Picture;
...
public final class GrayscalePicture implements ActionListener {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.StdOut.printf("%d-by-%d\n", picture.width(), picture.height());
        GrayscalePicture copy = new GrayscalePicture(picture);
        picture.show();
        copy.show();
        while (!com.codeanalysis.algs4.StdIn.isEmpty()) {
            int row = com.codeanalysis.algs4.StdIn.readInt();
            int col = com.codeanalysis.algs4.StdIn.readInt();
            int gray = StdIn.readInt();
            picture.setGrayscale(row, col, gray);
            com.codeanalysis.algs4.StdOut.println(picture.get(row, col));
