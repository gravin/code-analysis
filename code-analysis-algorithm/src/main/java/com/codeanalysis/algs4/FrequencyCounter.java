...
public class FrequencyCounter {
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.ST<String, Integer> st = new ST<String, Integer>();
        ...
        com.codeanalysis.algs4.StdOut.println(max + " " + st.get(max));
        com.codeanalysis.algs4.StdOut.println("distinct = " + distinct);
