...
public final class StdRandom {
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.StdOut.println("seed = " + StdRandom.getSeed());
        for (int i = 0; i < n; i++) {
            com.codeanalysis.algs4.StdOut.printf("%2d ",   uniform(100));
            com.codeanalysis.algs4.StdOut.printf("%8.5f ", uniform(10.0, 99.0));
            com.codeanalysis.algs4.StdOut.printf("%5b ",   bernoulli(0.5));
            com.codeanalysis.algs4.StdOut.printf("%7.5f ", gaussian(9.0, 0.2));
            com.codeanalysis.algs4.StdOut.printf("%1d ",   discrete(probabilities));
            com.codeanalysis.algs4.StdOut.printf("%1d ",   discrete(frequencies));
            com.codeanalysis.algs4.StdOut.printf("%11d ",  uniform(100000000000L));
            StdRandom.shuffle(a);
            for (String s : a)
                com.codeanalysis.algs4.StdOut.print(s);
            StdOut.println();
        }
    }
