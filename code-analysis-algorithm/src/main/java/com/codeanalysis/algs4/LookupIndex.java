...
public class LookupIndex { 
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.In in = new In(filename);

        com.codeanalysis.algs4.ST<String, com.codeanalysis.algs4.Queue<String>> st = new com.codeanalysis.algs4.ST<String, com.codeanalysis.algs4.Queue<String>>();
        com.codeanalysis.algs4.ST<String, com.codeanalysis.algs4.Queue<String>> ts = new ST<String, com.codeanalysis.algs4.Queue<String>>();
        ...
        while (in.hasNextLine()) {
            ...
            for (int i = 1; i < fields.length; i++) {
                String val = fields[i];
                if (!st.contains(key)) st.put(key, new com.codeanalysis.algs4.Queue<String>());
        ...
        com.codeanalysis.algs4.StdOut.println("Done indexing");
        ...
        while (!com.codeanalysis.algs4.StdIn.isEmpty()) {
            ...
            if (st.contains(query)) 
                for (String vals : st.get(query))
                    com.codeanalysis.algs4.StdOut.println("  " + vals);
