...
import com.codeanalysis.algs4.BST;
...
public class AVLTreeST<Key extends Comparable<Key>, Value> {
    ...
    public Iterable<Key> keysInOrder() {
        com.codeanalysis.algs4.Queue<Key> queue = new com.codeanalysis.algs4.Queue<Key>();
     ...
     */
    private void keysInOrder(Node x, com.codeanalysis.algs4.Queue<Key> queue) {
        if (x == null) return;
    ...
    public Iterable<Key> keysLevelOrder() {
        com.codeanalysis.algs4.Queue<Key> queue = new com.codeanalysis.algs4.Queue<Key>();
        if (!isEmpty()) {
            com.codeanalysis.algs4.Queue<Node> queue2 = new com.codeanalysis.algs4.Queue<Node>();
            queue2.enqueue(root);
    ...
    private boolean check() {
        if (!isBST()) com.codeanalysis.algs4.StdOut.println("Symmetric order not consistent");
        if (!isAVL()) com.codeanalysis.algs4.StdOut.println("AVL property not consistent");
        if (!isSizeConsistent()) com.codeanalysis.algs4.StdOut.println("Subtree counts not consistent");
        if (!isRankConsistent()) com.codeanalysis.algs4.StdOut.println("Ranks not consistent");
    ...
    public static void main(String[] args) {
        ...
        for (String s : st.keys())
            com.codeanalysis.algs4.StdOut.println(s + " " + st.get(s));
        StdOut.println();
    }
}
