...
import com.codeanalysis.algs4.DirectedCycle;
...
import com.codeanalysis.algs4.TopologicalX;
...
public class DirectedCycleX {
    private com.codeanalysis.algs4.Stack<Integer> cycle;     // the directed cycle; null if digraph is acyclic

    public DirectedCycleX(com.codeanalysis.algs4.Digraph G) {
    ...
    public static void main(String[] args) {
        ...
        if (finder.hasCycle()) {
            com.codeanalysis.algs4.StdOut.print("Directed cycle: ");
            ...
            com.codeanalysis.algs4.StdOut.println("No directed cycle");
        }
        StdOut.println();
    }
