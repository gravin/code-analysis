...
public class Digraph {
    ...
    private com.codeanalysis.algs4.Bag<Integer>[] adj;    // adj[v] = adjacency list for vertex v
    ...
    public Digraph(int V) {
        ...
        this.E = 0;
        indegree = new int[V];
        adj = (com.codeanalysis.algs4.Bag<Integer>[]) new com.codeanalysis.algs4.Bag[V];
        for (int v = 0; v < V; v++) {
            adj[v] = new com.codeanalysis.algs4.Bag<Integer>();
        }
    }
     ...
     */
    public Digraph(com.codeanalysis.algs4.In in) {
