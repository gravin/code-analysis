...
import com.codeanalysis.algs4.Counter;
import com.codeanalysis.algs4.Interval1D;
...
public class Interval2D {
    private final com.codeanalysis.algs4.Interval1D x;
    private final com.codeanalysis.algs4.Interval1D y;
     ...
     */
    public Interval2D(com.codeanalysis.algs4.Interval1D x, com.codeanalysis.algs4.Interval1D y) {
        this.x = x;
        this.y = y;
    }
     ...
     */
    public boolean contains(com.codeanalysis.algs4.Point2D p) {
    ...
    public static void main(String[] args) {
        ...
        com.codeanalysis.algs4.Interval1D xInterval = new com.codeanalysis.algs4.Interval1D(xmin, xmax);
        com.codeanalysis.algs4.Interval1D yInterval = new Interval1D(ymin, ymax);
        Interval2D box = new Interval2D(xInterval, yInterval);
        box.draw();

        com.codeanalysis.algs4.Counter counter = new Counter("hits");
        for (int t = 0; t < trials; t++) {
            double x = com.codeanalysis.algs4.StdRandom.uniform(0.0, 1.0);
            double y = StdRandom.uniform(0.0, 1.0);
            com.codeanalysis.algs4.Point2D point = new Point2D(x, y);

            if (box.contains(point)) counter.increment();
            else                     point.draw();
        }

        com.codeanalysis.algs4.StdOut.println(counter);
